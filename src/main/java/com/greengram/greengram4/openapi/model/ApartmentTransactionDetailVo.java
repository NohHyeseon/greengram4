...
//ex >> 82,500 -> 82500 trim->앞뒤 공백 날려줌
    @JsonSetter("건축년도")
    ...
    @JsonSetter("월")
    public void setDealMonth(String dealMonth) {this.dealMonth = dealMonth;}

    @JsonSetter("일")
    public void setDealDay(String dealDay) {this.dealDay = dealDay;}
    ...
    @JsonSetter("전용면적")
    public void setAreaForExclusiveUse(float areaForExclusiveUse) {this.areaForExclusiveUse = areaForExclusiveUse;}
    ...
    @JsonGetter("getBuildYear")
    public String getBuildYear() {
        return buildYear;
    }

    @JsonGetter("getDealYear")
    public String getDealYear() {
        return dealYear;
    }
    @JsonGetter("getDealMonth")
    public String getDealMonth() {
        return dealMonth;
    }
    @JsonGetter("getDealDay")
    ...
    @JsonGetter("getApartmentName")
    public String getApartmentName() {
        return apartmentName;
    }
    @JsonGetter("getAreaForExclusiveUse")
